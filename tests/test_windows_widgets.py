...
@allure.suite("WindowsWidgets")
class TestWindowsWidgets:

    @allure.feature("Accordian")
    class TestAccordianPage:

        @allure.title("Check accordian btn")
    ...
    class TestAutoCompletePage:
        ...
        @allure.title("Check multiple input")
    ...
    class TestDatePickerPage:
        ...
        @allure.title("Check select date and time")
    ...
    class TestProgressBarPage:
        ...
        @allure.title("Check progress bar reset btn")
    ...
    class TestToolTipsPage:
        ...
        @allure.title("Check hover on btn")
        ...
        @allure.title("Check hover on input")
        ...
        @allure.title("Check hover on contrary")
        ...
        @allure.title("Check hover on text")
    ...
    class TestMenuPage:
        ...
        @allure.title("Check interact with menu items")
    ...
    @allure.feature("SelectMenu")
    class TestSelectMenuPage:

        @allure.title("Check select random value in 1st selector")
        ...
        @allure.title("Check select random value in 2nd selector")
        ...
        @allure.title("Check select random value in old style select menu")
        ...
        @allure.title("Check random multiselect drop down")
