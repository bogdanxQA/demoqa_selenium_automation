...
class BrowserWindowsPage(BasePage):
    ...
    @allure.step("Get text from sample page")
...
class ModalDialogsPage(BasePage):
    ...
    @allure.step("Check if modal is closed")
...
class FramesPage(BasePage):
    ...
    @allure.step("Get data from first frame")
...
class NestedFramesPage(BasePage):
    ...
    @allure.step("Switch to child frame")
